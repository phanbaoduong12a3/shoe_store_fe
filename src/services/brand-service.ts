...
export const updateBrandLogo = async (data: UpdateBrandLogoRequest): Promise<UpdateBrandLogoResponse> => {
    const formData = new FormData();
...
export const toggleBrandStatus = async (data: ToggleBrandStatusRequest): Promise<ToggleBrandStatusResponse> => {
