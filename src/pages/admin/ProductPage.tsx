...
import { Table, Card, Space, Button, App, Switch, Image, Modal, Input, Select, InputNumber } from "antd";
...
import { getProductsAction, toggleProductStatusAction, deleteProductAction } from "@/stores/product";
                ...
                <div className="filter-section">
                    <Space wrap>
                        ...
                        <InputNumber
                            ...
                            onChange={(value: any) => setFilters({ ...filters, minPrice: (value as number) || undefined })}
                        />
                        <InputNumber
                            placeholder="Giá tối đa"
                            style={{ width: 150 }}
                            formatter={(value: any) => `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                            onChange={(value: any) => setFilters({ ...filters, maxPrice: (value as number) || undefined })}
                        />
                    </Space>
                </div>
