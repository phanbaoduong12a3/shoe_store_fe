        ...
        <div className="my-order-page">
            <div className="page-header">
                <Flex align="center" gap={16}>
                    ...
                    <div>
                        <TextDefault fs={32} fw="700">Giỏ hàng của bạn</TextDefault>
                    ...
                    <div className="cart-items-section">
                        {cart.items.map((item, index) => {
                            ...
                            const discountPercent = hasDiscount
                                ? Math.round(((item.productId.price - item.productId.salePrice!) / item.productId.price) * 100)
                                : 0;
                                        ...
                                        <Flex vertical gap={12} style={{ flex: 1 }}>
                                            ...
                                            <Flex gap={16} align="center" className="price-quantity-row">
                                                ...
                                                <div className="quantity-section">
                                                    <TextDefault color="#6b7280" fs={14}>Số lượng:</TextDefault>
                                                    <InputNumber
                                                        min={1}
                                                        max={99}
                                                        value={item.quantity}
                                                        onChange={(val) => handleUpdateQuantity(
                                                            item.productId._id,
                                                            item.variantId,
                                                            val || 1
                                                        )}
                                                ...
                                                <div className="item-total">
                                                    <TextDefault color="#6b7280" fs={14}>Thành tiền:</TextDefault>
                            ...
                            {!isFreeShipping && subtotal > 0 && (
                                <div className="free-shipping-progress">
                                    <TextDefault fs={12} color="#6b7280">
                                        Mua thêm {(freeShippingThreshold - subtotal).toLocaleString("vi-VN")}đ để được miễn phí vận chuyển
                                    </TextDefault>
